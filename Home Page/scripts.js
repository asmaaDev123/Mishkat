(function () {
    ...
    /**
     * تقليل عدد مرات تنفيذ الوظيفة (Throttle)
     */
    ...
    /**
     * تقليل عدد مرات تنفيذ الوظيفة (Debounce)
     */
    ...
    const Navbar = {
        ...
        init() {
            ...
            this.dom.subscribeBtn      = document.getElementById('subscribeBtn');
            this.dom.subscribeDropdown = document.getElementById('subscribeDropdown');
            this.dom.mobileMenuBtn     = document.getElementById('mobileMenuBtn');
            this.dom.mobileMenu        = document.getElementById('mobileMenu');
            this.dom.mobileCloseAreas  = document.querySelectorAll('[data-mobile-close]');
            this.dom.navLinks          = document.querySelectorAll('.nav-link');
            this.dom.mobileLinks       = document.querySelectorAll('.navbar__mobile-link');
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 2: HERO - Parallax Effect
    ══════════════════════════════════════════════════════════════ */
    ...
    const Parallax = {
        ...
        init() {
            this.bg = document.getElementById('heroBg');
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 3: HERO - Particles System
    ══════════════════════════════════════════════════════════════ */
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 4: HERO - Scroll Indicator Fade
    ══════════════════════════════════════════════════════════════ */
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 5: HERO - Heading Shimmer Effect
    ══════════════════════════════════════════════════════════════ */
    ...
    const HeadingGlow = {
        ...
        init() {
            this.titleWord = document.querySelector('.title-word');
    ...
    const ImageLoader = {
        init() {
            ...
            const onReady = () => document.body.classList.add('hero-loaded');
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 7: HERO - Button Ripple Effect
    ══════════════════════════════════════════════════════════════ */
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 8: SHARED - Smooth Scroll
    ══════════════════════════════════════════════════════════════ */
    ...
    /* ══════════════════════════════════════════════════════════════
       SECTION 9: SHARED - Dynamic Styles Injection
    ══════════════════════════════════════════════════════════════ */
        ...
        init() {
            ...
            style.textContent = `
                ...
                .shimmer-active {
                    ...
                    animation: headingShimmer 6s ease-in-out infinite;
                }
                ...
                body:not(.hero-loaded) .hero-content { opacity: 0; }
                body.hero-loaded .hero-content {
                    opacity: 1;
                    transition: opacity 0.5s ease;
                }

                body:not(.hero-loaded) .hero-bg-image { opacity: 0; }
                body.hero-loaded .hero-bg-image {
                    opacity: 1;
    ...
    function init() {
        ...
        // --- رسالة نجاح ---
        console.log(
            '%c مشكاة | Mishkat %c App initialized successfully ✓',
